...
import { Globe, Cpu, Zap, BrainCircuit, ShieldCheck, Layers } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "امتلاك كامل للمنصة والبيانات دون الاعتماد على حلول مغلقة، مع مرونة كاملة في التوسع والتطوير.",
      icon: <ShieldCheck size={20} className="text-primary" />,
    },
    {
      title: "هندسة معيارية",
      description: "بنية تقنية قابلة للتوسع والتكامل مع الأنظمة الأخرى، تمكن المؤسسات من تطوير خدماتها الرقمية دون تعقيد.",
      icon: <Layers size={20} className="text-primary" />,
    },
    {
      title: "أمان واعتمادية",
      description: "منصات مبنية وفق معايير أمان متقدمة تضمن استقرار الأنظمة وحماية البيانات الحساسة.",
      icon: <ShieldCheck size={20} className="text-primary" />,
    },
  ];

  return (
    <section id="about" className="py-32 bg-bg-page relative overflow-hidden" dir="rtl">
          ...
          <div className="lg:w-1/2 text-right">
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
                ...
                <span className="text-primary text-[10px] uppercase tracking-[0.2em] font-bold">Why Tabayun</span>
              </div>
              ...
              <p className="text-text-muted text-lg leading-relaxed mb-12 max-w-xl mr-0 ml-auto">
                نحن لا نقدم مجرد برمجيات، بل نبني أصولاً رقمية استراتيجية. نمكن المؤسسات من امتلاك منصات رقمية مستقرة وقابلة للتوسع، تدار بمعايير واضحة وتدعم النمو المستدام.
              </p>
            ...
            {cards.map((card, i) => (
              ...
              >
                ...
                <div className="mt-auto">
                  <h3 className="text-3xl font-bold text-white mb-1 tracking-tighter">{card.title}</h3>
                  <p className="text-white/40 text-xs font-bold">{card.subtitle}</p>
                </div>
              </motion.div>
            ))}
          </div>
